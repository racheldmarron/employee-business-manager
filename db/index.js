  ...
  inquirer
    .prompt([
      ...
      },
      {
        ...
        type: "input",
        message:
          "What is the Department ID for this new role? Please select 1 for Engineering, 2 for Product, 3 for Design, 4 for Data Research, 5 for Legal, 6 for HR.",
        choices: [1, 2, 3, 4, 5, 6],
      },
    ])
    .then(function (answer) {
  ...
  inquirer
    .prompt([
      ...
      },
      {
        name: "newRoleSalary",
        type: "input",
        message: "What is their updated salary?",
      },
      {
        name: "newRoleDeptID",
        type: "list",
        message: "What department will they belong to? Please select 1 for Engineering, 2 for Product, 3 for Design, 4 for Data Research, 5 for Legal, 6 for HR.",
        choices: [1, 2, 3, 4, 5, 6]
      },
    ])
    .then(function(answer) {
